...
var Mmodal = new _Modal2.default();
...
var Modal = function () {
  function Modal() {
    ...
    this.mainModal = (0, _jquery2.default)(".modal");
  ...
  _createClass(Modal, [{
    ...
    value: function events() {
      ...
      //pushes any key
      (0, _jquery2.default)(document).keyup(this.keyPressHandler.bind(this)); //document takes all the code from this site.
    }
  }, {
    key: "keyPressHandler",
